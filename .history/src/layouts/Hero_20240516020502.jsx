  ...
  return (
    <div className="bg-gray-900">
      <header>
        ...
        >
          <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 pb-2 md:flex md:px-8">
            <Brand />
            <div
      ...
      <section className="relative">
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-12 pt-10 pb-20 md:px-8">
