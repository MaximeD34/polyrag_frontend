...
import { The requested module '/node_modules/.vite/deps/react-router-dom.js?v=7fa5176a' does not provide an export named 'useHistory } from "react-router-dom";
  ...
  return (
    <div className="bg-gray-900">
      <header>
        ...
        >
          <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-10 pb-2 hidden md:flex  md:px-8">
            <Brand />
            <div
