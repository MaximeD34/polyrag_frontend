...
const MainLayout = () => {
  ...
  return (
    <div className="bg-gray-900">
      <header>
        <nav
          className={`pb-11 md:text-sm ${"absolute z-20 top-0 inset-x-0 bg-gray800 rounded-xl mx-8 mt-2 md:mx-0 md:mt-0 md:relative md:bg-transparent"}`}
        >
          <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-10 pb-2 md:flex md:px-8">
            <Brand />
            <div
